class BattlefieldView extends Battlefield {
  root = null; // приложение
  table = null; // поле
  dock = null; // див в котором будут храться корабли
  polygon = null; // полигоны для хранения выстрелов
  showShips = true; // видимость кораблей
  ...
  constructor(showShips = true) {
    ...
    //   создаем маркеры для обозначения ячеек (координаты)
    for (let x = 0; x < 10; x++) {
